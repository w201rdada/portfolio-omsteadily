...
The data is available via the Twitter API; the primary challenge here is translating it into a virtual space.  Toolsets like WebVR are making it easier for people other than professional game developers to build things, but they are still crude [@misc].  Ideally, this would be a collaboration of someone proficient in something like Unity with a data scientist.
