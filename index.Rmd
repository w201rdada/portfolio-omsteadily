...
library(magrittr)
readLines('https://www.zotero.org/api/users/4661701/items/top?limit=25&format=bibtex&key=5Yip9dhgsOmIZFesgtXSyzpZ&v=1') %>% writeLines('references.bib')
